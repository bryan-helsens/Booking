...
const COMPONENTS = [
  ...
  },
  {
    ...
    propsSchema: {
      ...
      buttonLabel: { type: 'string', label: 'Knoptekst' },
      bgImage: { type: 'image', label: 'Achtergrondafbeelding' },
    },
    defaults: { title: 'Klaar om te beginnen?', text: 'Boek vandaag nog je afspraak.', buttonLabel: 'Boek nu', bgImage: '' },
  },
  {
    type: 'stats',
    label: 'Cijfers',
    ...
    propsSchema: {
      title: { type: 'string', label: 'Titel' },
      bgColor: { type: 'color', label: 'Achtergrondkleur' },
      items: {
        type: 'repeater',
        label: 'Cijfers',
        addLabel: 'Cijfer toevoegen',
        itemFields: { value: { type: 'string', label: 'Waarde' }, label: { type: 'string', label: 'Label' } },
      },
    },
    defaults: { title: '', bgColor: '', items: [{ value: '1000+', label: 'Tevreden klanten' }, { value: '4.9', label: 'Gemiddelde score' }, { value: '10', label: 'Jaar ervaring' }] },
  },
  {
    type: 'team',
    label: 'Team',
    icon: 'UserFilled',
    category: 'content',
    propsSchema: { title: { type: 'string', label: 'Titel' } },
    defaults: { title: 'Ons team' },
  },
  {
    type: 'imagetext',
    ...
    category: 'content',
    propsSchema: {
      image: { type: 'image', label: 'Afbeelding' },
      heading: { type: 'string', label: 'Kop' },
      body: { type: 'textarea', label: 'Tekst' },
      imageSide: { type: 'select', label: 'Afbeelding aan', options: ['left', 'right'] },
    },
    defaults: { image: '', heading: 'Over ons', body: 'Vertel hier je verhaal in een paar zinnen.', imageSide: 'left' },
  },
  {
    type: 'video',
    label: 'Video',
    icon: 'VideoCamera',
    category: 'content',
    propsSchema: { title: { type: 'string', label: 'Titel' }, url: { type: 'string', label: 'YouTube / Vimeo URL' } },
    defaults: { title: '', url: '' },
  },
  {
    type: 'features',
    ...
    propsSchema: {
      ...
      items: {
        ...
        itemFields: {
          icon: { type: 'select', label: 'Icoon', options: ['Star', 'Check', 'Clock', 'Trophy', 'Medal', 'MagicStick', 'Sunny', 'Service'] },
          title: { type: 'string', label: 'Titel' },
          text: { type: 'string', label: 'Tekst' },
        },
      },
    },
    defaults: { title: 'Waarom voor ons kiezen', items: [{ icon: 'Trophy', title: 'Vakmanschap', text: 'Jarenlange ervaring en oog voor detail.' }, { icon: 'Clock', title: 'Flexibel', text: 'Eenvoudig online boeken, 24/7.' }, { icon: 'Star', title: 'Topservice', text: 'Persoonlijke aandacht voor elke klant.' }] },
  },
  {
    type: 'spacer',
    label: 'Witruimte',
...
const TENANTS: TenantSeed[] = [
  {
    ...
    pageSections: [
      ...
      { id: 's4b', type: 'features', visible: true, props: { title: 'Waarom Acme', items: [{ icon: 'MagicStick', title: 'Ervaren therapeuten', text: 'Gediplomeerd en met passie voor je welzijn.' }, { icon: 'Clock', title: '24/7 online boeken', text: 'Plan je moment van rust wanneer het jou uitkomt.' }, { icon: 'Sunny', title: 'Serene omgeving', text: 'Even helemaal weg van de drukte.' }] } },
  ...
  },
  {
    ...
    pageSections: [
      ...
      { id: 's4b', type: 'team', visible: true, props: { title: 'Onze barbers' } },
