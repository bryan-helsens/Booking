...
<style scoped>
.booking { background: linear-gradient(135deg, var(--app-color-primary), var(--app-color-secondary)); color: #fff; text-align: center; }
.title { font-size: 2rem; margin-bottom: 12px; }
.inner :deep(.el-button) { margin-top: 20px; }
</style>
