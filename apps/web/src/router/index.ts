  ...
  routes: [
    // ── Storefront (public, database-driven) ──
    {
      ...
      children: [
        ...
        { path: 'privacy', name: 'privacy', component: () => import('@/storefront/LegalView.vue') },
        { path: 'voorwaarden', name: 'terms', component: () => import('@/storefront/LegalView.vue') },
    ...
    { path: '/embed', name: 'embed', component: () => import('@/storefront/EmbedView.vue') },
    {
      ...
      children: [
        ...
        { path: 'billing', name: 'billing', component: () => import('@/admin/views/BillingView.vue') },
